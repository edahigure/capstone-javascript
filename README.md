...
**JavaScript Capstone** a dynamic SPA website, using ES6 syntax, modules, callbacks and promises. With webpack configuration to create a javascript bundle to reduce the server requests and the web performance. Unit testing with Jest using AAA pattern, asynchronous JavaScript code, and following the GitFlow repository structure guidelines. The main purpose of the app is to retrieve and send data from multiple APIs.
...
```
git clone https://github.com/jorgeabrahan/javascript_capstone.git
```
...
To run the project, if you are on the javascript_capstone folder path on your terminal you can execute the following command:
...
- GitHub: [@edahigure](https://github.com/edahiguren)
- Portfolio: [Edahi Gutierrez](https://edahigure.github.io/real-portfolio/)
...
- **What is this project main purpose?**
  ...
  - To practice working with Webpack, JavaScript bundles, APIs, Promises, and Async code in general.
